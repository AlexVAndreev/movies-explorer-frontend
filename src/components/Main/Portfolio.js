    ...
    <section className="portfolio">
      ...
      <ul className="portfolio__list">
        <li className="portfolio__item">
          <a
            className="portfolio-item_link"
            href="https://github.com/AlexVAndreev/how-to-learn"
            target="_blank"
          >
            {" "}
            <p className="portfolio__item-title">Статичный сайт</p>{" "}
            <img className="portfolio-img" src={linkPointer} alt="link" />
          </a>
        </li>
        <li className="portfolio__item">
          <a
            className="portfolio-item_link"
            href="https://github.com/AlexVAndreev/russian-travel"
            target="_blank"
          >
        ...
        <li className="portfolio__item">
          <a
            className="portfolio-item_link"
            href="https://github.com/AlexVAndreev/react-mesto-auth"
            target="_blank"
          >
